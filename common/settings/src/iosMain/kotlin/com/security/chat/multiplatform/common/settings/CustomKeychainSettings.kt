...
@file:Suppress("all") //code from third party library
...
/**
 * Copy of KeychainSettings class from library https://github.com/russhwolf/multiplatform-settings/tree/main
 * version 1.1.1
 *
 * Added
 * kSecAttrAccessible to kSecAttrAccessibleAfterFirstUnlock,
 * in keys val to be able to access keychain when app is in background
 */
@ExperimentalSettingsImplementation
public class CustomKeychainSettings : Settings {
    ...
    public class Factory : Settings.Factory {
        override fun create(name: String?): CustomKeychainSettings =
            if (name != null) CustomKeychainSettings(name) else CustomKeychainSettings()
    }
